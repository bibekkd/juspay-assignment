...
export const OrderToolbar: React.FC<OrderToolbarProps> = ({
    ...
    return (
        <div className="bg-bw-card-light dark:bg-bw-card-dark p-1 rounded-lg mt-2 mb-4 flex flex-col h-auto gap-2">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
                ...
                <div className="flex items-center gap-2 w-full lg:w-[160px] h-[28px] bg-white dark:bg-bw-bg-dark-66 border border-gray-200 dark:border-bw-border-dark rounded-lg px-2 py-1">
